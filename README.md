...
The game's dialogues in `Spanish are not 100%` translated, they are `16.47% translated`, but if you want to help us you can enter the repository to the following file
